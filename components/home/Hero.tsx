...
function Hero() {
  ...
  return (
    <>
      ...
      >
        <p className="text-xl mb-5">Hey, I'm Rana Rabees.</p>
        <h1 className="heroTitle inline-block max-w-2xl lg:max-w-4xl  w-auto relative text-5xl md:text-6xl lg:text-7xl tracking-tighter mb-10 font-bold heroShinyBg">
          I am <span className="heroShiny1 text-fun-pink"> Full Stack </span> {" "}
          <span className="heroShiny1 text-fun-pink"> <TextLoop loopItems={loopItems} delay={3000} /> </span>
          {" "}Developer.
          <img
          ...
          />
          <img
            className="sqD bottom-[-300px] -right-1/4 sm:right-[-20%] lg:bottom-[-330px] lg:right-[-120px] w-[300px]"
            style={{ animationDelay: "0.3s" }}
            src="/static/doodles/hero/programmer.svg"
          />
          ...
          />
          <img
            className="sqD right-[-60px] sm:right-0 bottom-[-80px] lg:[5%]"
        ...
        <div className="cursor-pointer font-bold whitespace-nowrap px-10 py-4 text-fun-white border-2 text-xl rounded-full border-fun-white bg-bg hover:bg-fun-pink hover:text-white hover:border-fun-pink transition-colors">
          <a href="/static/cv/RanaRabees.pdf" target="_blank">Hire Me</a>
        </div>
