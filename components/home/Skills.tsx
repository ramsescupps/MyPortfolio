...
function Skills() {
  return (
    <div className="flex flex-col md:flex-row justify-between relative">
      ...
      <div className="relative max-w-lg w-full mx-auto md:mx-none grid gap-x-8 gap-y-12 sm:gap-8 md:gap-12 grid-cols-3 sm:grid-cols-4 items-center place-content-center">
        {skills.map((item, index) => {
          return (
            ...
            >
              ...
              <p className="text-lg text-fun-gray font-bold opacity-80">
                {item.title}
              </p>
            </div>
          );
